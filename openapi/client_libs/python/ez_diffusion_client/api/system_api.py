...
class SystemApi:
    ...
    def get_memory_info(
        ...
        _param = self._get_memory_info_serialize(
    ...
    @validate_call
    def get_memory_info_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[MemoryInfoResponse]:
        """Get memory information
    ...
    @validate_call
    def get_memory_info_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_memory_info_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
