...
class ImageGenerationParamsDimensions(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "width": obj.get("width") if obj.get("width") is not None else 512,
            "height": obj.get("height") if obj.get("height") is not None else 512
        })
        return _obj
