...
class ValidationError(BaseModel):
    ...
    ValidationError
    """ # noqa: E501
    detail: Optional[List[ValidationErrorDetailInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "detail": [ValidationErrorDetailInner.from_dict(_item) for _item in obj["detail"]] if obj.get("detail") is not None else None
        })
        return _obj
