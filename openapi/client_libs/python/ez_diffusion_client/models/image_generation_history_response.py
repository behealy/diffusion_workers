...
class ImageGenerationHistoryResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["prev", "next", "results"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "prev": obj.get("prev"),
            "next": obj.get("next"),
            "results": [ImageGenerationResponse.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
