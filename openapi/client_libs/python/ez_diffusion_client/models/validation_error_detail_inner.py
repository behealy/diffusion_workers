...
class ValidationErrorDetailInner(BaseModel):
    """
    ValidationErrorDetailInner
    """ # noqa: E501
    loc: Optional[List[ValidationErrorDetailInnerLocInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "loc": [ValidationErrorDetailInnerLocInner.from_dict(_item) for _item in obj["loc"]] if obj.get("loc") is not None else None,
            "msg": obj.get("msg"),
            "type": obj.get("type")
        })
        return _obj
