...
class TestImageToImageParams(unittest.TestCase):
    """ImageToImageParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ImageToImageParams:
        """Test ImageToImageParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ImageToImageParams`
        """
        model = ImageToImageParams()
        if include_optional:
    ...
    def testImageToImageParams(self):
        """Test ImageToImageParams"""
