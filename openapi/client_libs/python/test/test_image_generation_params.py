...
class TestImageGenerationParams(unittest.TestCase):
    """ImageGenerationParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ImageGenerationParams:
        """Test ImageGenerationParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ImageGenerationParams`
        """
        model = ImageGenerationParams()
        if include_optional:
    ...
    def testImageGenerationParams(self):
        """Test ImageGenerationParams"""
