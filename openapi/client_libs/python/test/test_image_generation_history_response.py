...
class TestImageGenerationHistoryResponse(unittest.TestCase):
    """ImageGenerationHistoryResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ImageGenerationHistoryResponse:
        """Test ImageGenerationHistoryResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ImageGenerationHistoryResponse`
        """
        model = ImageGenerationHistoryResponse()
        if include_optional:
            return ImageGenerationHistoryResponse(
                prev = 56,
                next = 56,
                results = [
                    ez_diffusion_client.models.image_generation_response.ImageGenerationResponse(
                        ...
                        result = , 
                        warnings = [
                            ez_diffusion_client.models.op_result.OpResult(
                                operation = '', 
                                status = 'PENDING', 
                                message = '', )
                            ], )
    ...
    def testImageGenerationHistoryResponse(self):
        """Test ImageGenerationHistoryResponse"""
