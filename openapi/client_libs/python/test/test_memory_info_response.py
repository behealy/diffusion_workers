...
class TestMemoryInfoResponse(unittest.TestCase):
    """MemoryInfoResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MemoryInfoResponse:
        """Test MemoryInfoResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MemoryInfoResponse`
        """
        model = MemoryInfoResponse()
        if include_optional:
    ...
    def testMemoryInfoResponse(self):
        """Test MemoryInfoResponse"""
