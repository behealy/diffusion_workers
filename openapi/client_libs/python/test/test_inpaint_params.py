...
class TestInpaintParams(unittest.TestCase):
    """InpaintParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InpaintParams:
        """Test InpaintParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InpaintParams`
        """
        model = InpaintParams()
        if include_optional:
