...
class TestValidationErrorDetailInnerLocInner(unittest.TestCase):
    """ValidationErrorDetailInnerLocInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValidationErrorDetailInnerLocInner:
        """Test ValidationErrorDetailInnerLocInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValidationErrorDetailInnerLocInner`
        """
        model = ValidationErrorDetailInnerLocInner()
        if include_optional:
            return ValidationErrorDetailInnerLocInner(
            )
        else:
            return ValidationErrorDetailInnerLocInner(
        )
    ...
    def testValidationErrorDetailInnerLocInner(self):
        """Test ValidationErrorDetailInnerLocInner"""
